...
namespace Controllers
{
    public class UIPanelController : MonoBehaviour
    {
        ...
        [SerializeField] List<Transform> layers = new();
...
#else
            Destroy(layers.GetChild(0).gameObject);
#endif
            }
        }
...
#if UNITY_EDITOR
            DestroyImmediate(layers[value].GetChild(0).gameObject); //oyunu başlatmadan test etmek için [Button]
#else
